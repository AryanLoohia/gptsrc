...
def parse_args():
    ...
    parser.add_argument("--model_name_or_path", "-m", default="data/runs/ioi--elr-llr-relr-rllr-es-/")
    ...
    parser.add_argument("--data-path", "-d", default="./data/dataset/ioi/")
...
def main():
    ...
    print("Model embed size:", model.get_input_embeddings().num_embeddings)
